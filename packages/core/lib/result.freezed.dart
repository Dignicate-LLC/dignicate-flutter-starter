...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Success<T> value)?  success,TResult Function( _Failure<T> value)?  failure,TResult Function( _Unauthorized<T> value)?  unauthorized,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Success<T> value)  success,required TResult Function( _Failure<T> value)  failure,required TResult Function( _Unauthorized<T> value)  unauthorized,}){
final _that = this;
switch (_that) {
case _Success():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Success<T> value)?  success,TResult? Function( _Failure<T> value)?  failure,TResult? Function( _Unauthorized<T> value)?  unauthorized,}){
final _that = this;
switch (_that) {
case _Success() when success != null:
return success(_that);case _Failure() when failure != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( T value)?  success,TResult Function( String message)?  failure,TResult Function()?  unauthorized,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Success() when success != null:
return success(_that.value);case _Failure() when failure != null:
return failure(_that.message);case _Unauthorized() when unauthorized != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( T value)  success,required TResult Function( String message)  failure,required TResult Function()  unauthorized,}) {final _that = this;
switch (_that) {
case _Success():
return success(_that.value);case _Failure():
return failure(_that.message);case _Unauthorized():
return unauthorized();}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( T value)?  success,TResult? Function( String message)?  failure,TResult? Function()?  unauthorized,}) {final _that = this;
switch (_that) {
case _Success() when success != null:
return success(_that.value);case _Failure() when failure != null:
return failure(_that.message);case _Unauthorized() when unauthorized != null:
...
class _Unauthorized<T> implements Result<T> {
  const _Unauthorized();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Unauthorized<T>);
}
