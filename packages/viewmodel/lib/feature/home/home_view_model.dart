...
import 'package:viewmodel/feature/home/home_view_state.dart';
...
class HomeViewModel extends ChangeNotifier {
  ...
  HomeViewState _uiState = const HomeViewState();
  HomeViewState get uiState => _uiState;
  ...
  void _fetch() async {
    ...
    _uiState = switch (resource) {
      Resource.data(:final data) => HomeViewState(currentTime: data.iso8601),
